...
#define BFD_VERSION 235000000
#define BFD_VERSION_STRING  "(SiFive Binutils-Metal 0.10.5-2021.01.0-preview2) " "2.35"
#define REPORT_BUGS_TO "<https://github.com/sifive/freedom-tools/issues>"
